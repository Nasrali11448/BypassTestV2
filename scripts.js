document.getElementById('bypassButton').addEventListener('click', function () {
  ...
  grecaptcha.ready(function () {
      grecaptcha.execute('6LfpMioqAAAAAPUBYoyFddhjghE8tuJbSvAmnl19', { action: 'submit' }).then(function (token) {
          axios
              .post(apiUrl, {
                  link: linkToBypass,
              ...
              .then(response => {
                  ...
                  setTimeout(() => {
                      if (data.bypassed) {
                          ...
                          resultText.innerHTML = bypassedLink.length > 23 ? bypassedLink.substring(0, 23) + '...' : bypassedLink;
              ...
              .catch(error => {
                  ...
                  setTimeout(() => {
                      resultText.innerHTML = '<p class="text-red-500">An error occurred while bypassing.</p>';
